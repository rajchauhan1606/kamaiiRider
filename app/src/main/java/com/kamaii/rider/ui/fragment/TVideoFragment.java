...
public class TVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.rvtvideo.setLayoutManager(mLayoutManager);
*/
        ...
        new HttpsRequest(Consts.GET_TVIDEO, parms, getActivity()).stringPost(TAG, new Helper() {
            ...
            public void backResponse(boolean flag, String msg, JSONObject response) {
                ...
                if (flag) {
                  ...
                  //  binding.rvtvideo.setVisibility(View.VISIBLE);
                  ...
                  //      binding.rvtvideo.setAdapter(tvideoAdapter);
              ...
              //      binding.tvNo.setVisibility(View.VISIBLE);
               ////     binding.rvtvideo.setVisibility(View.GONE);
